...
Buildings.DrugStation = require("./drug_station")
Buildings.ThermalProcessor = require("./thermal_processor")
Buildings.DrugVat = require("./drug_vat")
...
Buildings.RedSporeling = require("./crops/red_sporeling")
Buildings.BrownSporeling = require("./crops/brown_sporeling")
Buildings.WhiteSporeling = require("./crops/white_sporeling")
Buildings.OrangeSporeling = require("./crops/orange_sporeling")
Buildings.YellowSporeling = require("./crops/yellow_sporeling")
Buildings.GreenSporeling = require("./crops/green_sporeling")
Buildings.BlueSporeling = require("./crops/blue_sporeling")
Buildings.PurpleSporeling = require("./crops/purple_sporeling")
Buildings.PinkSporeling = require("./crops/pink_sporeling")
Buildings.BlackSporeling = require("./crops/black_sporeling")
Buildings.Sapling = require("./crops/sapling")
