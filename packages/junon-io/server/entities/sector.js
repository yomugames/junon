...
class Sector {
  ...
  canEditSetting(key) {
    ...
    if(this.gameMode === 'survival') {
      let allowedSettingChanges = ['isPvPAllowed',"isFovMode", "isZoomAllowed", "showMiniMap", "showPlayerList", "isFloorAutodirt", "isChatEnabled", "isShadowsEnabled", "isPlayerSavingEnabled", "isBloodEnabled", "isGravityEnabled", "isItemBreakingEnabled", "isGunsShootThroughWalls", "isSpectateAllowed"]
